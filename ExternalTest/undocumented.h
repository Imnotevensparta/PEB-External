...
typedef enum _PROCESS_INFORMATION_CLASS2 {
    ...
    MaxProcessInfoClass
} PROCESS_INFORMATION_CLASS2, * PPROCESS_INFORMATION_CLASS2;
...
typedef NTSTATUS(__stdcall* tNtOpenProcess)(
...
typedef NTSTATUS(__stdcall* tNtQueryInformationProcess) (
	...
	IN PROCESS_INFORMATION_CLASS2 ProcessInformationClass,
